...
var DatalistPolyfill = function(document) {
    ...
    function convert(input, datalist, listItems) {
        ...
        var positionList = function() {
            ...
            fakeList.style.top = input.getBoundingClientRect().top + window.pageYOffset + input.offsetHeight + 'px';
            fakeList.style.left = input.getBoundingClientRect().left + 'px';
            fakeList.style.width = input.offsetWidth + 'px';
        };

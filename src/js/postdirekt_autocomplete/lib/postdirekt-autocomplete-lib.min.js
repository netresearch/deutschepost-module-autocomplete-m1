var postdirektAutocompleteLib = (function () {
    'use strict';
    ...
    ***************************************************************************** */
    ...
    (function (SearchSubject) {
        SearchSubject["Buildings"] = "buildings";
        SearchSubject["Cities"] = "cities";
        SearchSubject["Districts"] = "districts";
        SearchSubject["PostalCodes"] = "postalcodes";
        SearchSubject["PostalCodesCities"] = "postalcodes_cities";
        SearchSubject["PostalCodesCitiesDistricts"] = "postalcodes_cities_districts";
        SearchSubject["PostalCodesCitiesDistrictsStreets"] = "postalcodes_cities_districts_streets";
        SearchSubject["PostalCodesCitiesStreets"] = "postalcodes_cities_streets";
    })(SearchSubject || (SearchSubject = {}));
    var SearchSubject$1 = SearchSubject;
    ...
    var SearchRequest = /** @class */ (function () {
        function SearchRequest(url, method, headers) {
    ...
    var SearchRequestBuilder = /** @class */ (function () {
        ...
        SearchRequestBuilder.prototype.create = function (options) {
            ...
            return new SearchRequest(this.buildUrl(country, subject, params), 'GET', __assign(__assign({}, DefaultSettings.headers), { Authorization: "Bearer " + this.accessToken }));
        };
        /**
         ...
         * @param params QueryParams
         */
        SearchRequestBuilder.buildQueryString = function (params) {
    ...
    var ListRenderer = /** @class */ (function () {
        ...
        ListRenderer.prototype.remove = function () {
            ...
            var datalist = document.querySelector("[id=\"datalist-" + this.currentField.id + "\"]");
            if (datalist) {
                datalist.remove();
            }
    ...
    var AddressAutocomplete = /** @class */ (function () {
        ...
        AddressAutocomplete.prototype.start = function () {
            var e_1, _a;
            try {
                for (var _b = __values(this.inputMap.values()), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var fieldItem = _c.value;
        ...
        AddressAutocomplete.prototype.searchAction = function (currentField) {
            ...
            var subject = addressData.street
                ? SearchSubject$1.PostalCodesCitiesStreets
                : SearchSubject$1.PostalCodesCities;
        ...
        AddressAutocomplete.prototype.selectAction = function (uuid) {
            this.selectService.select(this.selectService.requestBuilder.create({
                country: 'de',
                subject: SearchSubject$1.PostalCodesCitiesStreets,
                uuid: uuid,
            }));
        };
